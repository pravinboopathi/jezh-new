...
export default function Login({ children }) {
  ...
  return (
    <div
      ...
      className="relative group w-auto h-auto cursor-pointer p-2 px-6 shadow-custom rounded-lg font-jost  bg-purple-500 text-center font-semibold uppercase transform hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 overflow-hidden z-50"
